    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Reviewer_Comments', models.CharField(choices=[('Installation pending', 'Installation pending'), ('Document verification in progress', 'Document verification in progress'), ('Installation Completed', 'Installation Completed'), ('KYC failed', 'KYC failed')], max_length=50)),
